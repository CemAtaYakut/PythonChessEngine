""" Satranç oyununun mevcut durumuna ilişkin tüm bilgilerin depolanması.
Geçerli hamlelerin mevcut durumda belirlenmesi.
Hamle günlüğünün tutulması.
"""


class GameState:
    def __init__(self):
        """ Tahta, 8x8 boyutunda bir 2D listedir ve listedeki her bir öğe 2 karakterden oluşur.
        İlk karakter, taşın rengini temsil eder: 'b' (siyah) veya 'w' (beyaz).
        İkinci karakter, taşın türünü temsil eder: 'R' (kale), 'N' (at), 'B' (fil), 'Q' (vezir), 'K' (şah) veya 'p' (piyon).
        "--" ifadesi, üzerinde taş bulunmayan boş bir alanı temsil eder.
        """
        self.board = [
    ...
    def makeMove(self, move):
        """ Bir Hamleyi parametre olarak alır ve bu hamleyi gerçekleştirir.
        (bu, rok, piyon terfisi ve geçerken alma hamleleri için geçerli olmayacaktır)
        """
    ...
    def updateCastleRights(self, move):
        """
        Hamleye göre rok yapma haklarını güncelle.
        """
    ...
    def getValidMoves(self):
        """
        Şahı kontrol eden tüm hamleler
        """
    ...
    def inCheck(self):
        """
        Mevcut oyuncunun şah tehdidi altında olup olmadığını belirle.
        """
        if self.white_to_move:
    ...
    def squareUnderAttack(self, row, col):
        """
        Düşmanın, belirtilen satır ve sütundaki kareye saldırıp saldıramayacağını belirle.
        """
    ...
    def getAllPossibleMoves(self):
        """
        Şah tehdidini dikkate almadan tüm hamleler.
        """
        moves = []
    ...
    def getPawnMoves(self, row, col, moves):
        """
        Belirtilen satır ve sütundaki piyona ait tüm hamleleri al ve bu hamleleri listeye ekle.
        """
        piece_pinned = False
        pin_direction = ()
    ...
    def getRookMoves(self, row, col, moves):
        """
        Belirtilen satır ve sütundaki kaleye ait tüm hamleleri al ve bu hamleleri listeye ekle.
        """
        piece_pinned = False
        pin_direction = ()
        for i in range(len(self.pins) - 1, -1, -1):
    ...
    def getKnightMoves(self, row, col, moves):
        """
         Belirtilen satır ve sütundaki ata ait tüm hamleleri al ve bu hamleleri listeye ekle.
        """
        piece_pinned = False
        for i in range(len(self.pins) - 1, -1, -1):
            if self.pins[i][0] == row and self.pins[i][1] == col:
    ...
    def getBishopMoves(self, row, col, moves):
        """
        Belirtilen satır ve sütundaki file ait tüm hamleleri al ve bu hamleleri listeye ekle.
        """
        piece_pinned = False
        pin_direction = ()
        for i in range(len(self.pins) - 1, -1, -1):
    ...
    def getQueenMoves(self, row, col, moves):
        """
        Belirtilen satır ve sütundaki vezire ait tüm hamleleri al ve bu hamleleri listeye ekle.
        """
    ...
    def getKingMoves(self, row, col, moves):
        """
        Belirtilen satır ve sütundaki şaha ait tüm hamleleri al ve bu hamleleri listeye ekle.
        """
    ...
    def getCastleMoves(self, row, col, moves):
        """
        Belirtilen satır ve sütundaki şaha ait tüm geçerli rok hamlelerini oluştur ve bu hamleleri hamle listesine ekle.
        """
...
class Move:
    ...
    def __eq__(self, other):
        """
        equals yöntemini geçersiz kılma (override etme).
        """
